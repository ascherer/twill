<!DOCTYPE html>
<html lang="en"><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><link rel="stylesheet" href="TWIMAC.TEX[TEX,SYS]%20-%20www.SailDart.org-Dateien/u8.css"><meta charset="utf-8">
<title>TWIMAC.TEX[TEX,SYS] - www.SailDart.org</title>
</head>
<body id="u8body">
<div id="tagline">perm filename TWIMAC.TEX[TEX,SYS]  blob <a href="https://saildart.org/TWIMAC.TEX[TEX,SYS]_blob">sn#846747</a> filedate 1987-10-11 generic text, type T, neo UTF8</div>
<pre id="u8lump">% Special formatting for Computers and Typesetting: The Programs

% Note: A bug was corrected since the first edition was printed;
% this makes the paging come out differently, so the files probably
% need to be edited (to tidy up page breaks) before a new edition is prepared.
...
\def\readrefs{\the\prefs \mm=\modno \advance\mm-\baseno \advance\mm200
  {\def\λ##1{\global\let##1\relax}\pp=200 %  this patch made AFTER first edition
